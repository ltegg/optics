...
#
# This script relies on the following external references:
#  [1] EasyRGB. "Color math and programming code examples". 
#      http://www.easyrgb.com/en/math.php. Accessed 2017-07-27.
#  [2] "ASTM E308-01 2001 Standard Practice for the Computing the Colors of 
#      Objects by Using the CIE system". American Society for Testing and 
#      Materials. Westconshohoken, PA. https://www.astm.org/Standards/E308.htm.
#  [3] Fox, Mark. 2003. "Optical Properties of Solids". Oxford University
#      Press, Oxford, NY.        
